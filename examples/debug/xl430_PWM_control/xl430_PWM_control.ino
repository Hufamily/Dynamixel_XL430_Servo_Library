...
void loop() {  
  ...
  //// The value range for XL430 PWM control is -885 ~ 885
  int pinRead = map(analogRead(A0), 0, 1023, -885, 885); // mapping the potentiometer reading to value range of XL430
