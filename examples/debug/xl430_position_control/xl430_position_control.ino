...
void loop() {  
  ...
  //// The value range for XL430 position control is 0 ~ 4095 mapping 0 ~ 360 [°]
  //// int pinRead = map(analogRead(A0), 0, 1023, 0, 4095); // mapping the potentiometer reading to value range of XL430
  robot.setJointPosition(servoID, position);
  delay(100);
}
